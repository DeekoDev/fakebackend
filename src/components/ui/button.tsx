  ...
  "disabled-input rounded-lg flex gap-1.5 items-center clicky",
  {
    variants: {
      variant: {
        ...
        ghost:
          "bg-transparent text-light-600 hover:text-light-500 hover:bg-dark-500 font-medium",
      ...
      size: {
        ...
        "icon-sm": "h-8 w-8 justify-center items-center rounded-lg",
        "icon-lg": "h-12 w-12 justify-center items-center rounded-lg",
      },
    },
    defaultVariants: {
      variant: "default",
